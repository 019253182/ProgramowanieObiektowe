...
int Tablica::zmianaZawart( int wybierz_w, int wybierz_k, int nowy, int t)
{
	this->tablica[wybierz_k-1][wybierz_w-1].ustaw(nowy);
	return 0;
}

int Tablica::zmianaZawart( int wybierz_w, int wybierz_k, float nowy, int t)
{
	this->tablica[wybierz_k-1][wybierz_w-1].ustaw(nowy);
	return 0;
}

int Tablica::zmianaZawart( int wybierz_w, int wybierz_k, std::string nowy, int t)
{
	this->tablica[wybierz_k-1][wybierz_w-1].ustaw(nowy);
	return 0;
}
...
int Tablica::wyswietl(int t)
{
	...
	if(t==2)
	{
		...
		{
			for (int j = 0; j < lkolumn; j++)
				cout<<" "<<tablica[j][i].wartoscString;
			cout << endl;
		}
	}
